    ...
    >
      {isEmailSent && (
        <form
          ...
          className="bg-slate-600 text-sm p-8 shadow-lg w-96"
        >
          <h1 className="text-white text-center text-2xl"> Reset Password </h1>
          <p className="text-center text-sm mb-6 text-indigo-300">
            Enter your registered email address
          </p>

          <div className="mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-blue-800">
            <input
              type="email"
            ...
            {Array(6)
              ...
              .map((_, index) => (
                <input
                  ...
                  key={index}
                  required
                  className="w-12 flex flex-col mr-2 h-12 bg-blue-800 text-white text-center text-xl rounded-md"
      ...
      {isOtpSubmitted && isEmailSent && (
        <form
          ...
          className="bg-slate-600 text-sm p-8 shadow-lg "
        >
          <h1 className="text-white text-2xl"> New Password </h1>
          <p className="text-center mb-6 text-indigo-300">
